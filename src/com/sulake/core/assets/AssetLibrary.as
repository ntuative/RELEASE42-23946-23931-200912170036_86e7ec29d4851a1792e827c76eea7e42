package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_985:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_549:uint = 0;
      
      public static const const_807:String = "AssetLibraryReady";
      
      public static const const_1154:String = "AssetLibraryUnloaded";
      ...
      public function unload() : void
      {
         ...
         var_297 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1154));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_472 = _loc2_.manifest.copy();
         var_338 = _loc2_.resource;
         if(var_473)
         {
            AssetLibrary.fetchLibraryContents(this,var_472,var_338);
         }
         var_297 = true;
         dispatchEvent(new Event(AssetLibrary.const_453));
         dispatchEvent(new Event(AssetLibrary.const_807));
         if(var_473)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_924,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_985.splice(var_985.indexOf(this),1);
            --var_549;
            var_396 = null;
            var_668 = null;
            _loadedAssets = null;
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_864);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_472.child("library");
         if(_loc2_ == null)
         {
