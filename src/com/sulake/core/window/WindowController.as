package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private static var var_1318:Point = new Point();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_127,WindowParam.const_131);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1588 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_902:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1253:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_778;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_928);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_891 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_320,this,param1));
         return param1;
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_866;
                  if(testParamFlag(WindowParam.const_281))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_197))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_197))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_234:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_352,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_138))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_153,WindowParam.const_131))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        var_30 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_244,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_358:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_458);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_796,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_324:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_575,this,null));
                     if(var_23 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_377:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_831);
                  break;
               case WindowNotifyEvent.const_469:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_405:
                  if(!(var_30 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_458);
                     }
                  }
                  else if(var_30 & 0)
                  {
               ...
               case WindowNotifyEvent.const_204:
                  ...
                  break;
               case WindowNotifyEvent.const_352:
                  var_23.getRegionProperties(null,var_281);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_320:
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_780,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_698,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_891 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_362)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_635,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_234,this,null));
            }
         }
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_377,this,null));
         }
      }
         ...
         if(var_305 && var_495 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1318,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1318,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_281 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_450,this,var_23));
            }
            else
            {
               var_281.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_240,_type,var_86,var_30,_context,var_22,null,var_578,properties,var_582.concat(),_id) as WindowController;
         _loc2_.var_495 = var_495;
         _loc2_.var_305 = var_305;
         _loc2_.var_864 = var_864;
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1286,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_505;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
