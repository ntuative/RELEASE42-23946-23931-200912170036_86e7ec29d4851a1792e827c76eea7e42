package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_956:String = "_EXCLUDE";
      
      public static const const_1518:String = "_TEMP";
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1045,var_1046);
         var_870 = new Dictionary();
         var_1295 = new Dictionary();
         ParamCodeTable.fillTables(var_870,var_1295);
         var_1296 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_870)
            {
               delete var_870[_loc1_];
            }
            for(_loc1_ in var_1295)
            {
               delete var_1295[_loc1_];
            }
            var_1296.dispose();
            var_1296 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_956) == -1)
                  {
