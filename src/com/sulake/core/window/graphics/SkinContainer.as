package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2117 = new Dictionary();
         TypeCodeTable.fillTables(var_1489,var_2117);
         var_1267 = new Dictionary();
         var_2116 = new Dictionary();
         StateCodeTable.fillTables(var_1267,var_2116);
         ...
         var_487["null"] = NullSkinRenderer;
         if(var_359 == null)
         {
            var_359 = new Array();
            var_359.push(WindowState.const_61);
            var_359.push(WindowState.const_67);
            var_359.push(WindowState.const_86);
            var_359.push(WindowState.const_44);
            var_359.push(WindowState.const_74);
            var_359.push(WindowState.const_68);
            var_359.push(WindowState.const_83);
            var_359.push(WindowState.const_80);
         }
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1489[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_568[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_568[param1] = new Array(SkinContainer.const_1095);
         }
         var_568[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_568[_loc1_]).dispose();
