package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1396:uint = 64;
      ...
      protected var var_583:Boolean;
      
      protected var var_1522:Boolean;
         ...
         if(var_583)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1522,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1522,16777215);
                  }
                  var_358 += bitmap.width * bitmap.height * 4;
               }
