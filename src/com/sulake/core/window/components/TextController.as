package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_581 * maxScrollH,var_353 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_188,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1239,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_463,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_188,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_188,true));
         ...
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.const_188,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_711,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_188,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_711,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_497,PropertyStruct.const_188,var_497 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_711,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
