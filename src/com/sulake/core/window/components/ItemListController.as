package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_1047:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         _container = _context.create("_CONTAINER","",WindowType.const_284,WindowStyle.const_243,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_499 * maxScrollH,var_498 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("auto_arrange_items",var_704,PropertyStruct.const_57,var_704 != true));
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_500,PropertyStruct.const_57,var_500 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1047,PropertyStruct.const_57,var_1047 != false));
         return _loc1_;
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_447,param1);
            }
            else
            {
