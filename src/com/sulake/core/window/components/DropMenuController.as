package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_332:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_128 = context.create(name + "::submenu","",WindowType.const_407,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_452,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_284,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_433 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_433).setStateFlag(WindowState.const_44,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_510)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_432,getSubMenu(),subMenuEventProc);
                  var_510 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_449,this,null,true);
         update(this,_loc2_);
      ...
      {
         return getChildByName(DropMenuController.const_332) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_510 = false;
            getTitleText().text = var_433 < var_432.length && var_433 > -1 ? "null" : caption;
         }
      }
   }
}
