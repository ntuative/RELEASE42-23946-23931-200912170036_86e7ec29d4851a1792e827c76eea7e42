package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_340)
         {
            var_340 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_340)
            {
               var_340.addEventListener(WindowEvent.const_254,scrollBarEventProc);
               var_340.addEventListener(WindowEvent.const_209,scrollBarEventProc);
            }
         }
         return var_340;
      }
      ...
      override public function dispose() : void
      {
         if(var_340)
         {
            var_340.removeEventListener(WindowEvent.const_254,scrollBarEventProc);
            var_340.removeEventListener(WindowEvent.const_209,scrollBarEventProc);
            var_340 = null;
         }
         if(_cachedItemList)
         {
