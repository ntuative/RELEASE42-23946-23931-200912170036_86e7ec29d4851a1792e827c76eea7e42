package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1033:String = "_CONTENT";
      
      private static const const_1034:String = "_HEADER";
      
      private static const const_1031:String = "_SCALER";
      ...
      private var var_1115:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1115 == null)
         {
            var_1115 = findChildByTag(const_1034) as IHeaderWindow;
            if(!var_1115)
            {
      ...
      {
         return findChildByTag(const_1031) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1306 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_34 == null)
         {
            var_34 = findChildByTag(const_1033) as IWindowContainer;
            if(!var_34)
            {
