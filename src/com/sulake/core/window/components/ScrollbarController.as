package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1053:String = "increment";
      
      private static const const_486:String = "slider_bar";
      
      private static const const_1052:String = "decrement";
      
      private static const const_747:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0, param13:IScrollableWindow = null)
      {
         ...
         var_35 = param13;
         _horizontal = param3 == WindowType.const_456;
      ...
      {
         return getChildByName(ScrollbarController.const_747) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_754 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_754 != null)
         {
            _loc1_ = findParentByName(var_754) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_754) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1053)
            {
               if(var_35)
               {
                  var_532 = true;
            ...
            else if(param2.name == ScrollbarController.const_1052)
            {
               if(var_35)
               {
                  var_532 = true;
            ...
            else if(param2.name == ScrollbarController.const_747)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_775)
         {
