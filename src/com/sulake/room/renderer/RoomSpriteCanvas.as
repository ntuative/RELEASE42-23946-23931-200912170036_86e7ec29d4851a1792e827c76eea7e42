package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_744:RoomObjectLocationCache;
      ...
      private var var_1736:Number = -10000000;
      
      private var var_1734:Number = -10000000;
      ...
      private var var_925:IRoomRenderingCanvasMouseListener = null;
      
      private var var_924:Point;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_744 = new RoomObjectLocationCache(_loc6_);
         var_287 = new Map();
      ...
      public function update() : void
      {
         if(var_927 == 0)
         {
            checkMouseHits(var_924.x,var_924.y,MouseEvent.MOUSE_MOVE);
         }
         var_927 = 0;
         ++var_1346;
      }
      ...
      {
         var _loc11_:Number = param1 - var_928 / 2;
         var _loc12_:Number = param2 - var_926 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc8_ < var_131.length)
         {
            var_131.splice(_loc8_);
         }
         _loc3_ = getTimer();
         ErrorReportStorage.addDebugData("Canvas rendering split time","Canvas render split: " + (_loc3_ - _loc2_));
         var _loc12_:String = " ";
         ...
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorting sprites" + _loc12_ + var_131.length);
         var_131.sortOn("z",0 | 0);
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorted sprites" + _loc12_ + var_131.length);
         var _loc13_:* = null;
         var _loc14_:int = 0;
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
            _loc13_ = var_131[_loc7_] as SortableSprite;
            updateSprite(_loc7_,_loc13_);
            _loc13_.bitmapData = null;
            _loc7_++;
         }
         cleanSprites(var_131.length);
         var_1735 = param1;
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_287 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_287.getKey(_loc1_);
            _loc3_ = var_287.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_925 != null)
                  {
                     var_925.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1346,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_131.length)
         {
            return null;
         }
         return var_131[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1736 || param2 != var_1734)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_744.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_928 / 2);
         _loc8_ += int(var_926 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_928 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_926))
                     {
                        if(param3 + _loc10_ < var_131.length)
                        {
                           _loc11_ = var_131[param3 + _loc10_];
