package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_513:Number = 64;
      ...
      private var var_2250:Number = 500;
      ...
      private var var_2249:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_92 = new Vector3d();
         var_995 = new Vector3d();
         var_1445 = 1;
         var_1443 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1444 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_402 != param1 * var_1444)
         {
            var_402 = param1 * var_1444;
            ++var_84;
         }
      }
      ...
      {
         if(var_399 != param1 * var_1445)
         {
            var_399 = param1 * var_1445;
            ++var_84;
         }
      }
      ...
      {
         if(var_400 != param1 * var_1443)
         {
            var_400 = param1 * var_1443;
            ++var_84;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_995.assign(_loc22_);
         }
         else
         {
            var_995.assign(_loc17_);
         }
         ++var_84;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_400;
         _loc2_.z *= var_402;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_995);
         if(_loc3_ < var_2249 || _loc3_ > var_2250)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_400;
            _loc2_.z *= var_402;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_995);
         }
      ...
      {
         return new Vector3d(0 * var_399,0 * var_400,0 * var_402);
      }
      ...
      {
         return scale == const_513;
      }
      
      public function get scale() : Number
      {
         return var_192 / Math.sqrt(0.5);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_192;
         var _loc6_:Number = -param1.y / var_192;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_91,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_399,0 * var_400,0 * var_402);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_92;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_399,param2.y * var_400,param2.z * var_402);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_399,param3.y * var_400,param3.z * var_402);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_399,param4.y * var_400,param4.z * var_402);
