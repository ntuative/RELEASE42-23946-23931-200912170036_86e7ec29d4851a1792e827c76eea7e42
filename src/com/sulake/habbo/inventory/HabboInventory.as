package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1591:int = 500;
      ...
      private var var_1490:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_33 != null)
         {
            var_33.events.removeEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_467,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_54.getValue(InventoryCategory.const_719));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_54.getValue(InventoryCategory.const_69));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_779));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_54.getValue(InventoryCategory.const_162));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1591);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_54.getValue(InventoryCategory.const_321));
      }
      ...
      {
         return TradingModel(var_54.getValue(InventorySubCategory.const_253));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_570 = ISessionDataManager(param2);
      ...
      {
         return var_54.getValue(InventoryCategory.const_372) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1490 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_54.getValue(InventoryCategory.const_240));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionPropertyUpdateEvent.const_467,roomSessionEventHandler);
         ...
         var_54.add(InventoryCategory.const_372,_loc3_);
         ...
         var_54.add(InventoryCategory.const_69,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_570);
         var_54.add(InventoryCategory.const_240,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_54.add(InventoryCategory.const_719,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_570);
         var_54.add(InventoryCategory.const_321,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_54.add(InventorySubCategory.const_253,_loc8_);
         ...
         var_54.add(InventoryCategory.const_162,_loc10_);
