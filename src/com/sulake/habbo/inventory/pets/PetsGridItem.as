package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private var var_1244:PetData;
      
      private var _window:IWindowContainer;
      
      private var var_961:PetsView;
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_55:
               var_961.setSelectedGridItem(this);
               var_776 = true;
               break;
            ...
            case WindowMouseEvent.const_28:
               ...
               {
                  var_776 = false;
                  var_961.placePetToRoom(var_1244.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1578) : uint(const_1577);
      }
