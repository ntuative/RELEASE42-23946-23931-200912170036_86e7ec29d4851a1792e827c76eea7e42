package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_887:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_505 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_505.width;
         var_95 = var_505.height;
         var_886 = param5;
         var_712 = param6;
         var_209 = Math.floor(var_886 / _thumbWidth);
         var_31 = new BitmapData(var_886,var_712);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_209 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_209 - param1.x - 1;
         ...
         if(param1.y < var_429 - 1)
         {
            ...
            var_31.fillRect(new Rectangle(0,0 - var_95,var_31.width,var_95),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == var_209 - 1)
            {
               _loc11_ = new BitmapData(var_31.width,0 - var_95);
               _loc2_ = new Rectangle(0,0,var_31.width,0 - var_95);
               _loc11_.copyPixels(var_31,_loc2_,new Point(0,0),null,null,true);
               var_31 = _loc11_;
               --var_429;
            }
         }
         if(var_31.height < var_712)
         {
            _loc12_ = new BitmapData(var_31.width,var_712);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_505.width,var_505.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_505.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_505,var_505.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_887 != null)
         {
            _loc1_ = var_887.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_429 = resolveRowCountFromList();
         if(var_429 == 0)
         {
            var_31 = new BitmapData(var_886,var_712);
            return;
         }
         var_31 = new BitmapData(Math.max(var_209 * _thumbWidth,var_886),Math.max(var_429 * var_95,var_712),true,16777215);
         var_31.fillRect(var_31.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_429)
         {
            _loc4_ = 0;
            while(_loc4_ < var_209)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_31.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_95),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_209 && var_31.height < _loc3_.y * var_95)
         {
            _loc2_ = new BitmapData(var_31.width,var_31.height + var_95);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_209 - 1),var_95);
         _loc2_.copyPixels(var_31,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_209 - 1),0,_thumbWidth,var_31.height);
         _loc2_.copyPixels(var_31,_loc4_,new Point(0,var_95),null,null,true);
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_209 - 1),0 - var_95);
         _loc2_.copyPixels(var_31,_loc4_,new Point(_thumbWidth,var_95),null,null,true);
         var_31 = _loc2_;
      }
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_209));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_209);
         var _loc3_:int = param1 % var_209;
         return new Point(_loc3_,_loc2_);
      }
