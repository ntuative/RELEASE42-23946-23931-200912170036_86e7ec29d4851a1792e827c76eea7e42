package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_719);
         _loc2_.refreshViews();
         var_25.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_162);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_25.setInventoryCategoryInit(InventoryCategory.const_321);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_25.toggleInventorySubPage(InventorySubCategory.const_253);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_25.setInventoryCategoryInit(InventoryCategory.const_240);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_372);
         var _loc4_:FurniModel = var_25.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
