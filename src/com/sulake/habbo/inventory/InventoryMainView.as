package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_671 == InventoryCategory.const_162)
            {
               toggleCategoryView(InventoryCategory.const_162);
            }
            else if(var_671 == InventoryCategory.const_69)
            {
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_201 != null && var_809)
            {
               var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_201 != null)
         {
            var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_201 != null)
         {
            var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_697,HabboToolbarIconEnum.INVENTORY,var_28 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_201 != null && var_809)
         {
            var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_809 = false;
         }
         _controller.inventoryViewOpened(var_670);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_671 || !_controller.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_201 != null && var_809)
