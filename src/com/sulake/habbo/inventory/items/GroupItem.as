package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1577:int = 13421772;
      ...
      private const const_1387:Number = 0.2;
      
      protected var var_1307:Boolean;
      
      private const const_1388:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_534)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1292);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1388;
               _loc1_.blend = const_1388;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1307 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2189;
               _loc5_.visible = true;
            }
            else
            {
