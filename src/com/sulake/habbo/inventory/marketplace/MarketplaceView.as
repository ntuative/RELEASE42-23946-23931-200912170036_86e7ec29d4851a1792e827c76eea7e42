package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_87:MarketplaceModel;
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         checkPrice();
         _localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",var_87.expirationHours.toString());
         _localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",var_87.offerMinPrice.toString());
         _localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",var_87.offerMaxPrice.toString());
         ...
         var_1583 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_1583);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1315.toString());
      ...
      private function clickHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_194)
         {
      ...
      private function checkPrice() : void
      {
         ...
         if(_loc2_ > var_87.offerMaxPrice)
         {
            _loc1_.text = var_87.offerMaxPrice.toString();
            _loc2_ = 0;
         }
         ...
         if(_loc2_ < var_87.offerMinPrice)
         {
