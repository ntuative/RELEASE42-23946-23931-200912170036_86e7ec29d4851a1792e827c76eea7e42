package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_1012:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_484 = new Map();
         var_484.add(FurniModel.const_41,new FurniGridView(var_87,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_484.add(FurniModel.const_42,new FurniGridView(var_87,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "offertotrade_btn":
                  ...
                  break;
               case "sell_btn":
                  var_87.requestSelectedFurniSelling();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_52)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_295);
            }
         }
      }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_484.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_484.getValue(var_483);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_484.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_87.getGroupItemInIndex(_loc3_,var_483);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_278)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_1012 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_484.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
