package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1030:int = 100;
      
      public static const const_295:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_449 = new Timer(const_1030,1);
         var_449.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_374.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_374.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_534)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_449 != null)
            {
               var_449.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_449.stop();
               var_449 = null;
            }
            if(var_132 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_278)
         {
         ...
         var _loc10_:IWindowContainer = var_627.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_253:
               ...
               break;
            case InventorySubCategory.const_993:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_372);
         ...
         if(param1 == InventoryCategory.const_69 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_295:
                  _controller.toggleInventoryPage(InventoryCategory.const_162);
            }
         }
      }
      ...
      {
         if(var_746 && param1.type == RoomEngineObjectEvent.const_201)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_293 || _loc3_.category == FurniCategory.const_331 || _loc3_.category == FurniCategory.const_278)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_374.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_374 = new Map();
         var_374.add(const_41,new Array());
         var_374.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
