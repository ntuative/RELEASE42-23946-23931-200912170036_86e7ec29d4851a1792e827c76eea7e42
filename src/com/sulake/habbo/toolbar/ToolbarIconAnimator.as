package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         if(var_1158 == true || var_645 == 0)
         {
            if(false)
            {
               ++var_58;
               if(var_58 >= var_772.length)
               {
                  var_58 = 0;
                  ++var_645;
               }
      ...
      {
         return var_1158 == false && var_645 == 1 && var_1233 != _state;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_58 <= var_771.length)
         {
            _loc2_ = var_771[var_58];
