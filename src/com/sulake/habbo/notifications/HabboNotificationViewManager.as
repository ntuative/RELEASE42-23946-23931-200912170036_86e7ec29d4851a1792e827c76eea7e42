package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements ICoreUpdateReceiver
   {
      ...
      private static const const_492:int = 4;
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_492;
         var _loc2_:int = 0;
         while(_loc2_ < var_235.length)
         {
            _loc3_ = var_235[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_672 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_672 + const_492;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2098,var_411,var_201);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_672 < 540;
      }
   }
}
