package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1064:String = "pixelbalance";
      
      private static const const_1060:String = "credits";
      
      private static const const_1062:String = "inventory";
      
      private static const const_1059:String = "friendlist";
      
      private static const const_1061:String = "selectfurni";
      
      private static const const_1065:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_544:ParkBusDialogManager;
      
      private var var_1181:IHabboToolbar;
      ...
      private var var_388:HabboNotificationViewManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_786);
         }
         var _loc6_:Map = var_786["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_988)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1157);
         }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1138.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_933,_loc5_);
         }
      }
      ...
      {
         if(param1 != null && this.var_388 != null)
         {
            var_388.replaceIcon(param1);
         }
      }
      ...
      {
         if(var_388.isSpaceAvailable() && false)
         {
            var_388.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_544 == null)
         {
            var_544 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_544 != null)
         {
            var_544.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_967.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1138.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_570);
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_154 || param2.type == WindowEvent.const_640)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_87)
               {
                  _loc16_ = var_570.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_75)
               {
                  _loc16_ = var_570.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_570.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_998,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1138.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1181 = IHabboToolbar(param2);
         var_1181.events.addEventListener(HabboToolbarEvent.const_82,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_570.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_965);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_965);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_82)
         {
            ...
            var_388 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_786["styles"],var_786["view"],var_1181);
            ...
            registerUpdateReceiver(var_388,1);
            registerUpdateReceiver(this,2);
            var_570.events.addEventListener(BadgeImageReadyEvent.const_115,onBadgeImage);
            var_1181.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
