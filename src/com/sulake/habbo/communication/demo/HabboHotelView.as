   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_370));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_659.loadAssetFromFile("hotel_view_banner_" + var_789,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_516));
            }
            var_183 = param2;
