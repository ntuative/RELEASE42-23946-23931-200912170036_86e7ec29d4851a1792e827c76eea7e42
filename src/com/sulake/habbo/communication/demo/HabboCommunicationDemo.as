package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1906:PseudoRandom;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1907)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_661 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_661);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1190,var_1908));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1375,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1906);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1375,"/");
      ...
      {
         var_661 = _habboConfiguration.getKey("sso.ticket",null);
         var_1190 = _habboConfiguration.getKey("flash.client.url","");
         var_1908 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_176 == null)
         {
         ...
         if(var_661 != null)
         {
            var_78.mode = HabboConnectionType.const_417;
            var_78.initConnection(HabboConnectionType.const_250);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_653);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1906 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_78.mode)
         {
            case HabboConnectionType.const_417:
               ...
               var_980 = _loc4_;
               var_176.loadBannerImage(_loc7_ + "?token=" + var_980,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1345:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1238:
               var_978 = generateRandomHexString(30);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_21,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_96,onRoomSessionEnded);
      }
