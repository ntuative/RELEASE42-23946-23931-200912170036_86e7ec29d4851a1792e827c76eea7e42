package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1167:uint = 1;
      
      public static const const_1229:uint = 2;
       
      
      private var var_834:IProtocolDecoder;
      
      private var var_1006:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1006 = new WedgieEncoder();
         var_834 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1167)
            {
               _loc4_.position = 0;
               _loc6_ = var_834.getID(_loc4_);
