package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1680:BitmapData = null;
      
      private var var_630:IHabboCommunicationManager;
      
      private var var_613:int = 0;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_1676:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_365,0,0,_loc4_,var_1336,var_1676,var_1680));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1677 = int(_config.getKey("interstitial.interval","30000"));
         var_1678 = int(_config.getKey("interstitial.show.time","5000"));
         var_1334 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1094 = _loc2_.imageUrl;
         var_1336 = _loc2_.clickUrl;
         if(var_1094 != "" && var_1336 != "")
         {
            _loc3_ = var_1094;
            ...
            _loc4_ = new URLRequest(var_1094);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1095 = _loc2_.imageUrl;
         var_1679 = _loc2_.clickUrl;
         var_613 = getTimer();
         if(var_1095 != "")
         {
            _loc3_ = var_1095;
            ...
            var_214.start();
            _loc4_ = new URLRequest(var_1095);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_394,0,0,param1.bitmapData,var_1679));
            var_613 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1680 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1334 > 0 && var_1335 >= var_1334)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_613;
         if(_loc1_ > var_1677)
         {
            ++var_1335;
      ...
      {
         var_630 = param2 as IHabboCommunicationManager;
         if(var_630 == null)
         {
            return;
         }
         _connection = var_630.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1676 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
