package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1454:int = 1500;
      
      private var var_1455:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_607:
                  _loc2_.setString(RoomObjectVariableEnum.const_517,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_545:
                  _loc2_.setString(RoomObjectVariableEnum.const_700,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_633:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_408:
                  _loc8_ = "null";
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_878,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_810,int(_loc5_.bgOnly));
            var_1237 = _color;
            var_1455 = var_1194;
            var_999 = _loc11_;
            var_1456 = _loc12_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1191,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1211,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1309,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_139 || _loc13_ == RoomPlaneData.const_262)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_823)
         {
            ...
            {
               _loc6_ = var_1237 >> 16 & 255;
               _loc7_ = var_1237 >> 8 & 255;
               _loc8_ = var_1237 & 255;
               _loc9_ = var_999 >> 16 & 255;
               _loc10_ = var_999 >> 8 & 255;
               _loc11_ = var_999 & 255;
               _loc12_ = (_loc1_ - var_823) / var_1454;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1455 + (var_1456 - var_1455) * _loc12_;
               _color = _loc2_;
               var_1194 = _loc3_;
            }
