package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_749:Number = 1.5;
         ...
         if(object != null)
         {
            ...
            if(object.getType() == RoomObjectVisualizationEnum.const_114 || object.getType() == RoomObjectVisualizationEnum.BOT)
            {
               if(param1 is RoomObjectAvatarUpdateMessage)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_330,_loc5_.dirHead);
                  }
               }
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_309,new Date().valueOf());
                  }
                  else
                  {
               ...
               if(param1 is RoomObjectAvatarTypingUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_849,Number(_loc7_.isTyping));
               }
               ...
               if(param1 is RoomObjectAvatarDanceUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_972,_loc11_.danceStyle);
               }
               if(param1 is RoomObjectAvatarSleepUpdateMessage)
               {
                  _loc12_ = param1 as RoomObjectAvatarSleepUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_366,Number(_loc12_.isSleeping));
               }
               if(param1 is RoomObjectAvatarEffectUpdateMessage)
               {
                  _loc13_ = param1 as RoomObjectAvatarEffectUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_913,_loc13_.effect);
               }
               if(param1 is RoomObjectAvatarCarryObjectUpdateMessage)
               {
                  _loc14_ = param1 as RoomObjectAvatarCarryObjectUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_518,_loc14_.itemType);
                  if(_loc14_.itemType > 0)
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_496,new Date().valueOf());
                  }
                  else
                  {
                     _loc4_.setNumber(RoomObjectVariableEnum.const_496,-1);
                  }
               }
               if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
               {
                  _loc15_ = param1 as RoomObjectAvatarUseObjectUpdateMessage;
                  _loc4_.setNumber(RoomObjectVariableEnum.const_793,_loc15_.itemType);
               }
               if(param1 is RoomObjectAvatarGestureUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_347,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarSignUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_922,_loc18_.signType);
                  _loc4_.setNumber(RoomObjectVariableEnum.const_992,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  _loc19_ = param1 as RoomObjectAvatarPostureUpdateMessage;
                  _loc4_.setString(RoomObjectVariableEnum.const_258,_loc19_.postureType);
                  _loc4_.setString(RoomObjectVariableEnum.const_658,_loc19_.parameter);
               }
               if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
               {
                  ...
                  _loc4_.setNumber(RoomObjectVariableEnum.const_1264,Number(_loc20_.isAdmin));
               }
      ...
      private function targetIsWarping(param1:IVector3d) : Boolean
      {
         ...
         if(Math.abs(_loc2_.x - param1.x) > const_749 || Math.abs(_loc2_.y - param1.y) > const_749)
         {
            return true;
         }
         return false;
