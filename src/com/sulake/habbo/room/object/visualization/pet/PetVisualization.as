package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_829);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_908)
            {
               _loc9_ = uint(int(Math.sin(Number(_loc16_) / 0 * 0) * 255));
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_794);
               var_452 = const_1051;
            }
         }
         var _loc12_:Boolean = false;
         var _loc13_:String = _loc3_.getString(RoomObjectVariableEnum.const_258);
         switch(_loc13_)
         {
         ...
         var _loc14_:Boolean = var_277 != _loc2_.getUpdateID() || var_207 != param1.scale || var_184 != _loc3_.getUpdateID();
         ...
         if(_loc14_ || _loc15_)
         {
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_330);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc3_.getString(RoomObjectVariableEnum.const_258);
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_658);
            _loc5_.appendAction(AvatarAction.const_727,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            _loc23_ = _loc3_.getString(RoomObjectVariableEnum.const_380);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc37_ = _loc3_.getNumber(RoomObjectVariableEnum.const_347);
               _loc38_ = 3;
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_366) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1050;
            ...
            _loc30_ = getSprite(const_1575);
            if(_loc9_ > 0)
            {
               _loc28_ = null;
               _loc28_ = var_751.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc28_ != null)
               {
