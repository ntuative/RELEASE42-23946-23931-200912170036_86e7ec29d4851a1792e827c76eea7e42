package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_547:PlaneMaskManager;
      ...
      {
         super();
         var_546 = new WallRasterizer();
         var_545 = new FloorRasterizer();
         _landscapeRasterizer = new LandscapeRasterizer();
         var_547 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc6_ = _loc2_[0];
            var_546.initialize(_loc6_);
         }
         var _loc3_:XMLList = param1.floorData;
         if(_loc3_.length() > 0)
         {
            _loc7_ = _loc3_[0];
            var_545.initialize(_loc7_);
         }
