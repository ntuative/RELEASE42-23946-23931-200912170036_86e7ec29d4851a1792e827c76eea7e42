package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_635 = var_381.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_635 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_381 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_381.length)
            {
               _loc1_ = var_381.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
