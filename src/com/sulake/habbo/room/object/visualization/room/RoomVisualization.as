package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1298:int = 13421772;
      
      private static const const_1006:int = 16777215;
      
      public static const const_1340:int = 10066329;
      
      private static const const_1007:int = 13421772;
      
      public static const const_1156:int = 16777215;
      
      private static const const_1363:int = 0;
      
      public static const const_1343:int = 16777215;
      
      private static const const_1005:int = 10066329;
      ...
      private var var_1222:String = null;
      ...
      private var var_896:uint = 16777215;
      ...
      private var var_1614:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(var_82.getPlaneType(_loc4_) == RoomPlaneData.const_133)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_242 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         if(var_184 != _loc3_.getUpdateID())
         {
            ...
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_517);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_699);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_878);
            if(_loc8_ != var_1614)
            {
            ...
            var_1613 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_810));
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_175)
            {
               ...
               if(var_1613)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_896 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_896 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_896 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_82.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_242,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_242 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_109.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_242 || _loc3_.type == RoomPlane.const_175 && _loc8_ == RoomPlaneBitmapMaskData.const_215)
                  {
