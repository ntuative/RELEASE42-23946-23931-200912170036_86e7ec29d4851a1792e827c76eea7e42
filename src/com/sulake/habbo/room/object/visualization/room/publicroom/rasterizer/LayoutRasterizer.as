package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_919:Point = null;
      
      private var var_446:Array;
      
      private var var_920:LayoutRasterizerData = null;
      ...
      {
         var_444 = true;
         var _loc3_:int = var_321.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_321.push(param1);
            var_445.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_921 = param1;
         var _loc3_:LayoutRasterizerData = var_67.getValue(var_625);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1108 = RoomObjectVariableEnum.const_921;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1108 = RoomObjectVariableEnum.const_872;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_921 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_921 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_921 + _adBgIndex);
            _loc5_ = param1.getSprite(var_921 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1108);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1717);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_625)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_920 = var_67.getValue(var_625);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_67.getValue(var_625);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_920.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_919.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_919.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_321.indexOf(_loc10_) >= 0 && var_444)
            {
               param1 = var_321.indexOf(_loc10_);
               if(true)
               {
               ...
               if(true)
               {
                  param2.alpha = var_446[param1];
               }
               var_321.splice(param1,1);
               var_445.splice(param1,1);
               var_446.splice(param1,1);
               if(false)
               {
                  var_444 = false;
               }
