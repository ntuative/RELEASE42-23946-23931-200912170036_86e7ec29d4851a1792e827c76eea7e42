package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1477:int = 16777216;
      
      public static const const_1496:int = 1;
       
      
      private var var_2255:int = 69069;
      
      private var var_1270:int = 1;
      
      private var var_2254:int = 5;
      
      private var var_1500:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1500 * param2);
      }
      ...
      {
         var _loc1_:int = var_2255 * var_1270 + var_2254;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
