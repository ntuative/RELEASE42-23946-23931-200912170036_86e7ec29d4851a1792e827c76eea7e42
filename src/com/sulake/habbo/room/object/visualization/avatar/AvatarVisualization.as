package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1574:int = 1;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_651);
         ...
         var _loc13_:Number = _loc7_ - var_1125;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_309);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_277 != _loc2_.getUpdateID() || var_207 != param1.scale || var_184 != _loc3_.getUpdateID();
         ...
         if(_loc19_ || _loc20_)
         {
            ...
            if(_loc5_ == null)
            {
               _loc5_ = var_751.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_330);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_258) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_258);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_658);
            _loc5_.appendAction(AvatarAction.const_727,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_380);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_347);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_297,AvatarAction.const_1335[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_972);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_904,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_922);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_992);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_814,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_518);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_496);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_920,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_793);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_823,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_378);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_366) > 0;
            if(_loc34_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_416);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_913);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_620,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1575);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_849))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_751.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
