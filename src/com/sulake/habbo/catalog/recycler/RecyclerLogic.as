package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_744:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1357)
         {
            case RecyclerStatusMessageEvent.const_1185:
               var_255 = const_337;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_940:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1277:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1357 != RecyclerStatusMessageEvent.const_940;
      }
      
      private function get statusActive() : Boolean
      {
         return var_255 != const_744;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_988:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1320:
