package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
      ...
      private var var_172:Offer;
      
      private var var_527:ITextWindow;
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_528)
               {
                  ...
                  HabboCatalog(var_70).purchaseProduct(var_592,var_172,var_938,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_70).purchaseProduct(var_592,var_172,var_938);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         if(_window == null)
         {
            _window = var_70.windowManager.createWindow("OrderInfo","${catalog.purchase.confirmation.dialog.title}",HabboWindowType.const_314,HabboWindowStyle.const_40,0 | 0 | 0,new Rectangle(10,10,300,180),null) as IFrameWindow;
         }
         else
         {
         ...
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_688,onDeActivateGift);
            _loc17_.addEventListener(WindowEvent.const_499,onActivateGift);
         ...
         var _loc11_:IProductData = var_70.getProductData(var_172.localizationId);
         ...
         var _loc14_:String = "";
         var _loc15_:String = "";
         switch(var_172.priceType)
         {
            case Offer.const_277:
               _loc16_ = _localization.getLocalization("catalog.purchase.confirmation.dialog.price.credits");
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits","credits",var_172.priceInCredits.toString());
            ...
            case Offer.const_468:
               ...
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","credits",var_172.priceInCredits.toString());
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","pixels",var_172.priceInPixels.toString());
               _loc13_ = _loc16_.value;
            ...
            case Offer.const_406:
               ...
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.pixels","pixels",var_172.priceInPixels.toString());
               _loc13_ = _loc16_.value;
      ...
      private function updateSuggestions(param1:Array, param2:IWindow) : void
      {
         ...
         if(var_133 == null)
         {
            ...
            var_133 = var_70.windowManager.buildFromXML(_loc5_.content as XML) as IItemListWindow;
            if(var_133 != null)
            {
               var_527 = var_133.getListItemAt(0) as ITextWindow;
               var_527.procedure = suggestionsEventHandler;
            }
         }
         if(var_133 == null || var_527 == null)
         {
            return;
         }
         var_133.removeListItems();
         ...
         {
            _loc6_ = var_527.clone() as ITextWindow;
            if(_loc6_ != null)
            {
               _loc6_.text = _loc3_;
               var_133.addListItem(_loc6_);
            }
         }
         _loc4_ = new Rectangle();
         param2.getGlobalRectangle(_loc4_);
         var_133.setGlobalPosition(new Point(_loc4_.left,_loc4_.bottom + 10));
      }
   }
}
