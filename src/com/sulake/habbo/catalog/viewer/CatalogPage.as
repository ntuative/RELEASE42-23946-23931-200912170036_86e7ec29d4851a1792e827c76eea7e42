package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1355:String = "ctlg_";
      ...
      private var var_1201:EventDispatcher;
      ...
      {
         return _localization.hasLinks(var_803);
      }
      ...
      {
         var _loc2_:String = const_1355 + param1;
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1113) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1201;
            _loc2_.init();
         }
         var_1201.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1201.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_803);
      }
