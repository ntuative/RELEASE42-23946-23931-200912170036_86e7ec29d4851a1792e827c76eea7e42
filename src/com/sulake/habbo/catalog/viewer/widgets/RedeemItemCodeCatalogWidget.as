package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1019 != null)
         {
            var_1019.removeEventListener(WindowKeyboardEvent.const_120,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_1019 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1019 != null)
         {
            var_1019.addEventListener(WindowKeyboardEvent.const_120,windowKeyEventProcessor);
         }
      }
