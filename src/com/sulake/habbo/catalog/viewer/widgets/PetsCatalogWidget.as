package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_364 >= var_280.length)
         {
            return "";
         }
         var petColor:IPetColor = var_280[var_364] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_503[var_1310] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_364 = param1.index;
         if(var_364 < 0 || var_364 > var_280.length)
         {
            var_364 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_880.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_194,onTextWindowEvent);
         var_880 = new Map();
         ...
         var_707 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_280 = [];
         var_503 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_707);
               if(_loc11_)
               {
                  var_503 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_503.length)
         {
            _loc12_ = var_503[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_707,_loc12_.id),getRaceLocalizationKey(var_707,_loc12_.id)));
            _loc6_++;
         }
         var_880.add(var_707,_loc5_);
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_880.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_364 >= 0 && var_364 < var_280.length)
         {
            _loc7_ = var_280[var_364] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_503[var_1310] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_707,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_297,AvatarAction.const_582);
