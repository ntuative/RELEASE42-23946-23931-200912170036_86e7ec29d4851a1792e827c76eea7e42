package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_646.length)
         {
            createLevelItem(var_646[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_880 = new Map();
         var_646 = recycler.getPrizeTable();
         if(var_646 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_646[0].prizes.length > 0)
         {
            select(var_646[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1848) as IWindowContainer;
