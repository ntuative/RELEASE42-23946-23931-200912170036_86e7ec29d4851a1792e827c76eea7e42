package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_540[var_960] as Array;
      ...
      {
         var _loc2_:Offer = var_540[var_960][var_1839];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_390 || _loc1_.pricingModel == Offer.const_353)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_75 || _loc3_.productType == ProductTypeEnum.const_87)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        {
                           var_959.push(_loc5_);
                           var_540.push(new Array());
                        }
                        _loc6_ = var_959.indexOf(_loc5_);
                        (var_540[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_540)
         {
            if(var_1839 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1839] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_960 = var_871.getGridItemIndex(param1.view);
