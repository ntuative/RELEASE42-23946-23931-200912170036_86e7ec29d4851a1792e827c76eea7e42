package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_548 != null)
         {
            var_548.visible = false;
            var_548.destroyGridItems();
         }
         if(var_1203 != null)
         {
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_383:
                  _loc4_ = var_1202.clone();
                  if(var_548 != null)
                  {
                     var_548.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_548,var_1203,var_1297);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_245:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_297,AvatarAction.const_681);
                              _loc13_.appendAction(AvatarAction.const_620,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1411 = new Point(var_89.x,var_89.y);
         var_548 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1203 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_548 == null)
         {
         ...
         var_1202 = _loc2_.content as BitmapData;
