package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_684:PurchaseConfirmationDialog;
      ...
      private var var_406:ICatalogNavigator;
      ...
      {
         return var_570.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2097 && var_759 != null)
         {
            var_759.playSound(HabboSoundTypesEnum.const_981);
         }
         var_2097 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_570.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_75)
         {
            _loc3_ = var_570.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               var_1260 = param1.session.isPrivateRoom;
               if(var_90 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_197,false);
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_406 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_684 == null)
            {
               var_684 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_684.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      {
         var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_406.buildCatalogIndex(_loc2_);
         if(var_1010 != "")
         {
            var_406.openPage(var_1010);
            var_1010 = "";
         }
         else
         {
            var_406.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2096 && var_759 != null)
         {
            var_759.playSound(HabboSoundTypesEnum.const_918);
         }
         var_2096 = false;
      }
