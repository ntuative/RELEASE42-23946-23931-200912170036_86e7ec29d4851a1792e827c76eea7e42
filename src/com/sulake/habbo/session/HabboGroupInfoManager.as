package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = var_275.getValue(_loc2_.groupId);
         var_940[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(var_275.getValue(_loc4_) != null)
            {
               var_275.remove(_loc4_);
            }
            var_275.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return var_275.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = var_940[param1];
         if(_loc2_ == null)
         {
