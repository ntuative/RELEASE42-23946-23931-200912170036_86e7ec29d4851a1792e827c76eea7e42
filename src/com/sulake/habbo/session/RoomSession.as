package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_964:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_326 && _connection != null)
         {
      ...
      {
         return var_964 as IUserDataManager;
      }
