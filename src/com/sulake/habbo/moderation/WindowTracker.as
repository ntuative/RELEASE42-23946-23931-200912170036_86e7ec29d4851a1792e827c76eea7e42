package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_593:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1116:int = 7;
      
      public static const const_853:int = 3;
      
      public static const const_1151:int = 8;
      ...
      {
         var _loc2_:Dictionary = var_1383[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1383[param1] = _loc2_;
         }
         return _loc2_;
      }
