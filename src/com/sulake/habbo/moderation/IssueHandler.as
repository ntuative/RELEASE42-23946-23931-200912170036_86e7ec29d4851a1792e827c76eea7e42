package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_383:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.releaseBundle(var_118.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_383 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_955 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_383.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_118.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_955.load(_loc4_,var_118.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_118.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         for each(_loc6_ in _loc4_)
         {
            ...
            setCaption(_loc7_.findChildByName("category"),IssueCategoryNames.getCategoryName(_loc6_.method_4));
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_853,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_63 != null && false && var_118 != null)
         {
            var_63.issueManager.removeHandler(var_118.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_383 = new UserInfoCtrl(_window,var_63,_loc3_.message);
            var_383.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_118.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_118.id,3);
         checkAutoHandling();
         dispose();
      }
