package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1516:IMessageComposer;
      ...
      {
         var_779 = IWindowContainer(var_56.getXmlWindow("chatlog_roomheader"));
         var_778 = IWindowContainer(var_56.getXmlWindow("chatlog_chatline"));
         ...
         var_56.connection.send(var_1516);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_779.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_778.clone());
         _loc4_.color = var_1165[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
