package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_649:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_56,WindowTracker.const_593,_data.flatId),var_58,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_390);
         if(param1.flatId != var_390)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_390);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_649.isSelected);
         var_56.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1295,_loc2_,var_392.text,"",""));
         if(false)
         {
            var_56.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_963.isSelected,var_962.isSelected,var_649.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1257);
         }
      ...
      public function populate() : void
      {
         ...
         var_649 = ICheckBoxWindow(var_58.findChildByName("kick_check"));
         var_963 = ICheckBoxWindow(var_58.findChildByName("lock_check"));
         var_962 = ICheckBoxWindow(var_58.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_56.connection.send(new GetModeratorRoomInfoMessageComposer(var_390));
         Logger.log("BEGINNING TO SHOW: " + var_390);
      }
   }
}
