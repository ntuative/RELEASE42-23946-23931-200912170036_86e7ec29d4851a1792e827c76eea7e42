package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_56,WindowTracker.const_784,_data.userId),_callerFrame,var_1029,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ModActionCtrl(var_56,_data.userId,_data.userName,var_1193),_callerFrame,var_1029,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new RoomVisitsCtrl(var_56,_data.userId),_callerFrame,var_1029,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new SendMsgsCtrl(var_56,_data.userId,_data.userName,var_1193),_callerFrame,var_1029,false,true);
      }
