package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         _list = param3;
         var_1288 = param4;
         var_1487 = var_508.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1487 == null)
            {
               return;
            }
            _loc2_ = var_1487.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc3_ != null)
            {
               _loc3_.caption = IssueCategoryNames.getCategoryName(_loc6_.method_4);
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_508.assets.getAssetByName(_loc8_) as BitmapDataAsset;
