package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      public function ModerationMessageHandler(param1:ModerationManager)
      {
         ...
         _connection.addMessageEvent(new PublicSpaceCastLibsEvent(method_8));
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         onChatlog("Call For Help Chatlog: " + _loc2_.data.callId,WindowTracker.const_853,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_784,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      ...
      private function method_8(param1:PublicSpaceCastLibsEvent) : void
      {
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_593,_loc2_.data.roomId,_loc3_,_loc4_);
      }
