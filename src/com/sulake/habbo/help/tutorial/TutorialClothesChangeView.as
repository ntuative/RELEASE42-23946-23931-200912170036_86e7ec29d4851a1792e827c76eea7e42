package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_56.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_48,onShowMenuEvent);
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_48)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_56.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_430));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_550 = var_56.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_550.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_56.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU_ARROW,var_550));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_56.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_48,onShowMenuEvent);
      }
   }
}
