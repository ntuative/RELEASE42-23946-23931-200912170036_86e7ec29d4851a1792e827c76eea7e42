package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public static const const_255:String = "TUI_NAME_VIEW";
      
      public static const const_79:String = "TUI_MAIN_VIEW";
      
      public static const const_304:String = "TUI_CLOTHES_VIEW";
      
      public static const const_425:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_56 = param1;
         var_56.events.addEventListener(HabboHelpTutorialEvent.const_564,onTaskDoneEvent);
         var_56.events.addEventListener(HabboHelpTutorialEvent.const_539,onTaskDoneEvent);
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1014 = param2;
         var_1015 = param3;
         if(var_41 == null || var_41.id == const_79)
         {
            prepareForTutorial();
            showView(const_79);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1014 = true;
         if(var_41 != null && (var_41.id == const_255 || var_41.id == const_79))
         {
            showView(const_79);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1480;
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_564:
               var_1015 = true;
               if(var_41 != null && var_41.id == const_425)
               {
                  showView(const_79);
               }
               break;
            case HabboHelpTutorialEvent.const_539:
               if(var_41 != null && var_41.id == const_304)
               {
                  var_1263 = true;
                  disposeWindow();
               }
      ...
      {
         var_1013 = true;
         if(var_41 != null && (var_41.id == const_304 || var_41.id == const_79))
         {
            showView(const_79);
         }
      }
      ...
      {
         return var_1013 && var_1014 && var_1015;
      }
   }
}
