package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      {
         var_1282.reportedUserId = param1;
         var_1282.reportedUserName = param2;
         var_64.showUI(HabboHelpViewEnum.const_327);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_201 != null)
         {
            var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_64 = new HelpUI(this,_assetLibrary,_windowManager,var_1510,var_201);
         }
         return var_64 != null;
      }
      ...
      {
         var_1510 = IHabboLocalizationManager(param2);
      ...
      {
         var_630 = IHabboCommunicationManager(param2);
         var_1490 = new IncomingMessages(this,var_630);
      ...
      {
         if(var_630 != null && param1 != null)
         {
            var_630.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      {
         var_1511 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_1511.getKey(param1,param2,param3);
      }
   }
}
