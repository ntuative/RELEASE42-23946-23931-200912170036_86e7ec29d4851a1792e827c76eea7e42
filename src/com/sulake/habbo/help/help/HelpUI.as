package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1385:int = 0;
      
      private static const const_1386:int = 0;
      ...
      private var var_2104:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23946-23931-200912170011");
         var_201 = param5;
         var_111 = new Map();
         var_111.add(HabboHelpViewEnum.const_1284,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_136,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_374,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_225,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_220,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_632,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         ...
         var_111.add(HabboHelpViewEnum.const_508,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_219,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_111.add(HabboHelpViewEnum.const_946,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_675,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_274 == HabboHelpViewEnum.const_136 || false)
         {
            return;
         }
         if(var_407 == null)
         {
            ...
            var_407 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_407 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_407 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_407 as IWindow);
      ...
      {
         return var_111.getValue(var_274);
      }
      ...
      {
         var_2103 = param1;
         var _loc2_:IHelpViewController = var_111.getValue(HabboHelpViewEnum.const_136) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_984:
               showUI(HabboHelpViewEnum.const_946);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_274 == HabboHelpViewEnum.const_136)
         {
            return;
         }
         if(true)
         {
            ...
            var_566.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_566.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_407.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_566[1],var_566[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_566[0],var_566[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1480;
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_201 != null)
            {
               var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_42.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_564));
      }
