package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1092:uint = 1;
      ...
      private var var_1256:IEventDispatcher;
      
      private var var_2285:uint = 0;
      
      private var var_1257:ProfilerAgentTask;
      
      private var var_1255:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_197 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1256 = Component(param1).events;
            var_835 = new Array();
      ...
      {
         return var_303[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_303[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_683 = new WindowRenderer(_loc4_);
         var_303 = new Array(const_341);
         var _loc6_:int = 0;
         while(_loc6_ < const_341)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_683,this,_localization,var_197,new Rectangle(0,0,var_197.stageWidth,var_197.stageHeight),this);
            var_303[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_382 = var_303[const_1092];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_382.getMouseCursor().defineCustomCursorType(MouseCursorType.const_300,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_382.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1269,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_303[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_303.pop()).dispose();
            }
            if(var_1255 != null)
            {
               var_1255.dispose();
      ...
      {
         return var_303[param1].getDesktopWindow().getChildAt(var_382.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1255 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1255 = new ProfilerOutput(_loc3_,this,var_683);
               var_1254 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1254);
               var_1257 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1257);
               var_1008 = true;
            }
         }
      }
      ...
      {
         return var_382.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1256.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_341 - 1;
            while(_loc2_ >= 0)
            {
               var_303[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1008)
         ...
         var_1256.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_341)
         {
            var_303[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1008)
         {
         ...
         var_1256.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_835[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_835[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_382.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1166,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1304,param2.name + ": " + param2.toString());
            }
         }
      }
   }
