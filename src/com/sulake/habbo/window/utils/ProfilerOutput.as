package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_372.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_372.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_372.removeStopEventListener(refresh);
            var_372 = null;
            _windowManager = null;
            var_683 = null;
            _disposed = true;
