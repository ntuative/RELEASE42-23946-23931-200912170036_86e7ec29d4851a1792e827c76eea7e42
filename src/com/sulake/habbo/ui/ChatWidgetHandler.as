package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_471:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_469 != null)
         {
            ...
            {
               _loc2_ = var_469.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_469.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_664.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_469.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_664.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_645,RoomWidgetChatSelectAvatarMessage.const_631];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_645:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           case "o/":
                              ...
                              break;
                           case ":sign":
                              _container.roomSession.method_9(int(_loc7_));
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_145,_container.roomSession,0,"Version 23946-23931-200912170011");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_315);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_349);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_113:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_92:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_631:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_471 == null)
            {
               ...
               var_470.y = 0;
               var_470.z = 0;
               var_471 = _loc4_.getScreenPoint(var_470);
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_471.x || _loc8_.y != var_471.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_471,_loc5_));
