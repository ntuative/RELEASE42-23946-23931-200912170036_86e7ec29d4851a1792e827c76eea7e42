package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_720);
               _loc6_.id = param1.id;
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_287);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_379)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_909)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_518);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_186)
               {
                  _loc11_.realName = _container.sessionDataManager.realName;
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_198)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_624);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1124;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_785;
                  }
                  if(!_loc25_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_985;
                  }
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1136);
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_602);
         _loc1_.push(RoomWidgetFurniActionMessage.const_584);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_562);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_625);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_507);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_598:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_828,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_691:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_602:
            ...
            case RoomWidgetUserActionMessage.const_396:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_562:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_625:
            ...
            case RoomWidgetUserActionMessage.const_671:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_507:
