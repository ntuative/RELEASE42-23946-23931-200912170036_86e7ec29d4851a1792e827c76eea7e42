package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_549,RoomWidgetEcotronBoxOpenMessage.const_610,RoomWidgetEcotronBoxOpenedMessage.const_1147];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_549:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_610:
