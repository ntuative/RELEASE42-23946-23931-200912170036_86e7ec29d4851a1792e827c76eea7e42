   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_914,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_501,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_430,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_501,onFigureUpdate);
         ...
         if(var_25 != null)
         {
            (var_25 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_779,onAvatarEffectsChanged);
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_594,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_430,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_430:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_446));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_523);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_613);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_540);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_604);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_587);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_601);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_646);
         _loc1_.push(RoomWidgetStopEffectMessage.const_510);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1232);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_939);
         _loc1_.push(RoomWidgetToolbarMessage.const_555);
         _loc1_.push(RoomWidgetToolbarMessage.const_615);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_726);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1256);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_874);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_674);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_559);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_544);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_709);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1327);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_656);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_595);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_712);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_718:
               ...
               break;
            case RoomWidgetDanceMessage.const_523:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_613:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_540:
               if(var_25 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_646:
               ...
               if(var_70 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_530)
               {
                  var_70.openCatalogPage(CatalogPageName.const_308,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_601:
               ...
               if(var_25 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_935:
                        var_70.openCatalogPage(CatalogPageName.const_1322,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_906:
                        var_25.toggleInventoryPage(InventoryCategory.const_240);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_510:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_923:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_939:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_674:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_555:
               ...
               if(var_201)
               {
                  var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_615:
               ...
               if(var_201)
               {
                  var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_427,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_726:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_429,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_865));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_429,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1202));
                     }
                  }
               ...
               break;
            case RoomWidgetRedeemClubPromoMessage.const_544:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_709:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_291,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_656:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_291,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_595:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_291,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_712:
               if(false && _container.habboHelp.events)
               {
