   ...
   public class DesktopLayoutManager
   {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_697;
               _loc2_.width = var_68.desktop.width - var_697;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_697;
               _loc2_.height = var_68.desktop.height - var_697;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_68.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1593) == 0)
            {
