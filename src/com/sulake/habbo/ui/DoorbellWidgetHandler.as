package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_97:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_531,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_118:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_118,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_609];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_609:
      ...
      {
         return [RoomSessionDoorbellEvent.const_97,RoomSessionDoorbellEvent.const_118,RoomSessionDoorbellEvent.const_103];
      }
