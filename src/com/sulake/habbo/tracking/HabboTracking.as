package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private static const const_759:uint = 11;
      ...
      private var var_1259:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1259 = new LagWarningLogger();
         var_1258 = new Array(const_759);
         var _loc4_:int = 0;
         while(_loc4_ < const_759)
         {
            var_1258[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_776,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_653:
               trackLoginStep(HabboLoginTrackingStep.const_23,String(_communication.port));
               break;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.addEventListener(HabboConfigurationEvent.const_21,onConfigurationLoaded);
            if(var_231 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_455.events.addEventListener(AdEvent.const_365,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_776,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_653,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_516,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_62,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_370,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_368:
               var_1259.registerWarning(LagWarningLogger.const_811);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_455)
            {
               var_455.release(new IIDHabboAdManager());
               var_455 = null;
            }
            if(_navigator)
            {
            ...
            if(var_179)
            {
               if(true)
               {
                  ...
                  Component(var_179).events.removeEventListener(HabboFriendListTrackingEvent.const_299,onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.removeEventListener(HabboConfigurationEvent.const_21,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_16,onLocalizationLoaded);
         }
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_9,onCoreRunning);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_222,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_179).events.addEventListener(HabboFriendListTrackingEvent.const_299,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_16,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_516)
         {
            trackLoginStep(HabboLoginTrackingStep.const_19);
         }
         else if(param1.type == HabboHotelViewEvent.const_370)
         {
