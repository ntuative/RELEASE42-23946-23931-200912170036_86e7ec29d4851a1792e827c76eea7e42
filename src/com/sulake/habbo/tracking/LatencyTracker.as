package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1466 = getTimer();
         var_479.add(var_1246,var_1466);
         _connection.send(new LatencyPingRequestMessageComposer(var_1246));
         ++var_1246;
      }
      ...
      public function init() : void
      {
         ...
         var_1467 = int(var_178.getKey("latencytest.interval"));
         var_1465 = int(var_178.getKey("latencytest.report.index"));
         var_2078 = int(var_178.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_159.push(_loc4_);
         if(var_159.length == var_1465 && var_1465 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1464) > var_2078 || var_1464 == 0)
            {
               var_1464 = _loc9_;
