package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_604[var_901] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_283)
         {
            ...
            var_283 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_283.center();
            var_283.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_901;
         if(var_901 < var_604.length)
         {
            _loc1_ = var_604[var_901] as Dictionary;
            if(!_loc1_)
            {
