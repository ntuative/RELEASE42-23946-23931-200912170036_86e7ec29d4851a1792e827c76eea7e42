package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1035:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_154.state = RoomChatHistoryPulldown.const_199;
         ...
         var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_995,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - const_485,param3.y,const_485,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_288 ? Number(const_485) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_218 > 0 && param2)
         {
            if(var_1116)
            {
               if(Math.abs(param1 - var_218) <= const_912)
               {
                  return;
               }
               var_1116 = false;
            ...
            if(var_288)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_50.scrollV < 1 - const_1035 / var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1352)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_288 && !var_1180)
         {
            ...
            var_154.state = RoomChatHistoryPulldown.const_275;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_154.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_199);
      }
