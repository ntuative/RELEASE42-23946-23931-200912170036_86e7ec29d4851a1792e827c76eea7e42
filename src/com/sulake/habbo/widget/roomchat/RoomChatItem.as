package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1377:Number = 10;
      
      private static const const_1376:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_956,var_957,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_956,var_957,_roomId,_roomCategory,param1);
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1153)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_111:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_92:
               _loc1_ = "bubble_shout";
               break;
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_958 != 0)
            {
               _loc31_ = uint(var_958 >> 16 & 255);
               _loc32_ = uint(var_958 >> 8 & 255);
               _loc33_ = uint(var_958 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1153 == RoomWidgetChatUpdateEvent.const_233)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_764);
            }
            else if(var_1153 == RoomWidgetChatUpdateEvent.const_267)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_764);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_339 + _loc20_.textWidth + const_487;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_956,var_957,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_956,var_957,_roomId,_roomCategory,param1);
      }
