package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_391:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_391.destroyGridItems();
         var_292 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1189) as IWindowContainer;
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_660.width,var_660.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_660,var_660.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_391.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_391.numGridItems)
         {
            return;
         }
         select(var_391.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_660 = BitmapData(_loc3_.content);
      }
