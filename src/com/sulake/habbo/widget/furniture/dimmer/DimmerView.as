package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1002,const_1003,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_996 = _loc2_.light;
         if(var_341 != null)
         {
            var_341.setValue(var_996);
         }
         var_364 = colors.indexOf(_loc2_.color);
         if(var_478 != null)
         {
            var_478.setSelectedColorIndex(var_364);
         }
