package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_378:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_993 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2035 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2036 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_677 = new Timer(1000,1);
         var_677.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_815 = new Timer(5000,1);
         var_815.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_120,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_194,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2037 = _loc2_.width + const_487 + _loc6_.width + const_1079;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1078,_loc8_.width) + const_487);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_993 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_139 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_378);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_378);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_477);
