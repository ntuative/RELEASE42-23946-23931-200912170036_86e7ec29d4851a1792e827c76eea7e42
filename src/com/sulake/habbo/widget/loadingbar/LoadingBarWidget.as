package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_360:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_360 = new Sprite();
            var_360.addChild(new Bitmap(_image));
            var_360.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_360.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_360);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1308 != "")
         {
            HabboWebTools.openWebPage(var_1308);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_360 != null)
         {
            var_360.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_360 = null;
         }
         if(_image != null)
         {
