package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1586:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1583:String = "level";
      
      private var var_104:IItemListWindow;
      
      private const const_1580:String = "energy";
      
      private var var_1244:Map;
      
      private const const_1582:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1585:uint = 3355443;
      
      private var var_210:IBorderWindow;
      
      private const const_1587:int = 158;
      
      private const const_1581:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_273:PetCommandTool;
      
      private const const_1579:uint = 11184810;
      
      private const const_1584:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_210 != null)
         {
            var_104 = var_210.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var _loc6_:IBitmapWrapperWindow = var_210.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_104 == null || var_210 == null || var_65 == null)
         {
            return;
         }
         ...
         var_210.height = NaN;
         _window.width = Math.max(var_210.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1244.getValue(var_598) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1583,param1.level,param1.levelMax);
         updateStateElement(const_1584,param1.experience,param1.experienceMax);
         updateStateElement(const_1580,param1.energy,param1.energyMax);
         updateStateElement(const_1582,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_598 = param1.id;
         var_1244.remove(param1.id);
         var_1244.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_357,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1587,const_1581,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1579);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1585);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1586);
         return _loc5_;
      }
