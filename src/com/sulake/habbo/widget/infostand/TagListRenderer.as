package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1570:int = 5;
      
      private const const_1569:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1151 != null && var_1151.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_713 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_713 += param1.height + const_1569;
            return fit(param1);
         }
         param1.offset(_offsetX,var_713);
         _offsetX += param1.width + const_1570;
         return true;
      }
