package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_654:MeMenuSettingsViewSlider;
      
      private var var_1389:BitmapData;
      
      private var var_1387:BitmapData;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_595);
         }
      ...
      {
         var_653 = param1.volume;
         if(var_654 != null)
         {
            var_654.setValue(var_653);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1388 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1387 = (_loc5_.content as BitmapData).clone();
         }
         var_654 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_709));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_653 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1388);
               }
               break;
            case "sounds_on":
               if(var_653 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1387);
               }
         }
      }
