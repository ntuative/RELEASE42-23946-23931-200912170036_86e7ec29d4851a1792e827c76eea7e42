   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_742 = _window.findChildByName("effect_hilite");
            var_742.visible = false;
         }
         var_740 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_741 = _window.findChildByName("loader_bar");
         if(var_741 != null)
         {
            var_378 = var_741.width;
            var_169.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_740 != null)
         {
            var_740.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_740.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
