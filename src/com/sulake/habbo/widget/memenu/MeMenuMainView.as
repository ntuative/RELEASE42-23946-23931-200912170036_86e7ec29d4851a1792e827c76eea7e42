      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_873);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_896));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_626);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_260);
               break;
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_659);
               break;
            case "news":
               if(false && false)
               {
