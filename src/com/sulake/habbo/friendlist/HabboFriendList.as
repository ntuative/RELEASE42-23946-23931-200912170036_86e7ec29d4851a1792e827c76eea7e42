package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1674:IAvatarRenderManager;
      
      private var var_1333:AvatarSearchResults;
      
      private var var_146:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_730:FriendRequests;
      
      private var var_1567:int;
      
      var var_316:FriendCategories;
      
      private var var_201:IHabboToolbar;
      
      private var var_1673:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_415:FriendListTabs;
      
      private var var_1675:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1332:OpenedToWebPopup;
      ...
      {
         var_1673 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_316 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1333 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1332 == null)
         {
            var_1332 = new OpenedToWebPopup(this);
         }
         var_1332.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_730.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_730.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_415.findTab(FriendListTab.const_100).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_730.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_146 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_316.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_730 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_316.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_316.addCategory(new FriendCategory(FriendCategory.const_795,getText("friendlist.friends")));
         var_316.addCategory(new FriendCategory(FriendCategory.const_466,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_316.addFriend(new Friend(_loc4_));
         }
         ...
         getBuddyRequests();
         registerListeners();
         var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_316.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1674.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1674 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_730.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_415.findTab(FriendListTab.const_100);
      ...
      {
         var_1675 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_316.getFriendCount(param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1333.searchReceived(_loc2_.friends,_loc2_.others);
