package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private function prepare() : void
      {
         ...
         var_859 = IWindowContainer(var_28.content.findChildByName("main_content"));
         var_268 = IWindowContainer(var_28.content.findChildByName("footer"));
         var_1224.prepare(var_859);
         var_28.procedure = onWindow;
         var_28.content.setParamFlag(HabboWindowParam.const_963,false);
         var_28.content.setParamFlag(HabboWindowParam.const_1243,true);
         var_28.header.setParamFlag(HabboWindowParam.const_714,false);
         var_28.header.setParamFlag(HabboWindowParam.const_777,true);
         var_28.content.setParamFlag(HabboWindowParam.const_714,false);
         var_28.content.setParamFlag(HabboWindowParam.const_777,true);
         var_28.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1225 = ITextWindow(var_28.findChildByName("info_text"));
         var_1225.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_28.scaler.setParamFlag(HabboWindowParam.const_882,this._friendList.tabs.findSelectedTab() != null);
         var_28.scaler.setParamFlag(HabboWindowParam.const_714,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_963,false);
         var_28.scaler.x = 0 - var_28.scaler.width;
         var_28.scaler.y = 0 - var_28.scaler.height;
         var_1440 = var_28.height;
         var_1439 = var_28.width;
