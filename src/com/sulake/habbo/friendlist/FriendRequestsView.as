package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1383:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_286 && _loc4_.state != FriendRequest.const_316)
            {
      ...
      {
         var_1462 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1461 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1461.procedure = onDismissAllButtonClick;
         var_1462.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
