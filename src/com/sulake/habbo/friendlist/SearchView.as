package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_665 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_665.procedure = onSearchInput;
         var_665.addEventListener(WindowKeyboardEvent.const_120,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            _list.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_323,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:String, param4:String, param5:String, param6:Boolean, param7:Boolean, param8:Boolean, param9:int) : Boolean
      {
         ...
         _friendList.refreshButton(_loc10_,"start_chat",param7,method_7,param9);
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_665.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
