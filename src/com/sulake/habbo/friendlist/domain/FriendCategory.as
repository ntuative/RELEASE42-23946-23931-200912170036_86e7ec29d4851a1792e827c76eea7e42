package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_795:int = 0;
      ...
      {
         return Math.ceil(this.var_230.length / const_298);
      }
      ...
      {
         if(this.var_831 >= this.getPageCount())
         {
            this.var_831 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_831 + 1) * const_298,this.var_230.length);
      }
