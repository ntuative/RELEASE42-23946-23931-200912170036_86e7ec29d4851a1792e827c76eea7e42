package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_558:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_557:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_558.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_558.setSelected(_loc2_);
            var_557.openMessenger();
            var_557.refresh(true);
         }
      }
      ...
      {
         var_558.addMessageAndUpdateView(param1);
         if(!var_557.isMessengerOpen())
         {
      ...
      {
         var_558 = new Conversations(new ConversationsDeps(this));
         var_557 = new MessengerView(this);
      ...
      {
         var_558.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_167,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_725,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_558.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_800,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_558.addMessageAndUpdateView(_loc3_);
      }
