package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_navigator.getXmlWindow(this.var_1124));
      ...
      public function show() : void
      {
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_254.desktop,var_254.width,var_254.height);
         var_254.x = _loc2_.x;
         var_254.y = _loc2_.y;
