package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1436:CutToHeight = new CutToHeight();
      
      private static var var_1437:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1436.beforeSearch(param2,param1,param3);
         binarySearch(var_1436,param2.length - 1);
      }
