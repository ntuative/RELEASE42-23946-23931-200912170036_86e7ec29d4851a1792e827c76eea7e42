package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1814:IWindowContainer;
      ...
      {
         setEnabled(_bgTabButton,this.var_87.mode != ThumbnailEditorModel.const_37);
         setEnabled(var_1362,this.var_87.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1361,this.var_87.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1362 = IButtonWindow(find("top_tab"));
         var_1361 = IButtonWindow(find("obj_tab"));
         var_1814 = IWindowContainer(find("tile_grid"));
         var_1815 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1362,onTopTabButton);
         Util.setProcDirectly(var_1361,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1814;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_375)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1815;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
