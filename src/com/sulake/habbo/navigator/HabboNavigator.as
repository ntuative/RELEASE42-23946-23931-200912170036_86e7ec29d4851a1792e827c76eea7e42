package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2274:Dictionary;
      ...
      private var var_1845:ISessionDataManager;
      
      private var var_1843:RoomCreateViewCtrl;
      
      private var var_1767:RoomThumbnailRenderer;
      
      private var var_201:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1161:RoomInfoViewCtrl;
      
      private var var_70:IHabboCatalog;
      
      private var var_415:Tabs;
      
      private var var_459:MainViewCtrl;
      
      private var var_1844:Array;
      
      private var var_970:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_459 = new MainViewCtrl(this);
         var_1161 = new RoomInfoViewCtrl(this);
         var_1843 = new RoomCreateViewCtrl(this);
         var_1767 = new RoomThumbnailRenderer(this);
         var_970 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_459.startSearch(Tabs.const_191,Tabs.const_307,param1);
         var_459.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_201 != null)
         {
            var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1845 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_459.startSearch(Tabs.const_232,Tabs.const_214);
         var_415.getTab(Tabs.const_232).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_459.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
