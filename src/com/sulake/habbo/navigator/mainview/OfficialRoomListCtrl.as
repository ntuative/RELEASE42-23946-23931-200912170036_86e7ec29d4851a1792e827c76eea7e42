package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1011:int = 267;
      
      private static const const_1012:int = 70;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.flatCategoryId > 0)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_441,"" + _loc2_.flatCategoryId,MainViewCtrl.const_724);
         }
         else
         {
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1013) : 0;
         param3.width = 274;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1012) : int(const_1011);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_550 || param2.type == OfficialRoomEntryData.TYPE_PUBLIC_SPACE))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
