package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class OfficialTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_468 == null)
         {
            var_468 = IDropMenuWindow(_loc3_.findChildByName("officialSubNavi"));
            var_468.procedure = onChangeNavi;
         }
         if(!var_1921 && _navigator.data.topLevelNodes != null)
         {
            prepareNavi();
         }
         _loc3_.visible = true;
      ...
      private function startSearch() : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_441,"" + _loc2_,MainViewCtrl.const_724);
      }
