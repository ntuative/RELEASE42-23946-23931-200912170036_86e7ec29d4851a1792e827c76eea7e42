package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_784:RoomLayout;
      ...
      private var var_1175:Timer;
      
      private var var_966:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1175 = new Timer(100);
         var_1175.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_67 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_966 = new TextFieldManager(_navigator,ITextFieldWindow(var_34.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_966.getText();
      ...
      {
         var_966.goBackToInitialState();
         var_966.input.textBackgroundColor = 4294967295;
         var_784 = var_67[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_966.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_784.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1174 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1174 = true;
            _loc3_.y = 1;
