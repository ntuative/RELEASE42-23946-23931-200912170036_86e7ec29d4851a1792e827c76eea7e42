package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1384:Boolean = true;
      
      private var var_169:Timer;
      
      private var var_1385:ITabSelectorWindow;
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_671 != null)
         {
            toggleCategoryView(var_671,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1385 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_671 = param1;
         var_1385.setSelected(var_1385.getSelectableByName(param1));
         _window.invalidate();
      }
