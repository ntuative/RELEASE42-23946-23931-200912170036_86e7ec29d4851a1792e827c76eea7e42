package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_943.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_942)
         {
            ...
            var_636["null"] = new FigureData(this);
            var_636["null"] = new FigureData(this);
            _loc1_ = var_636["null"];
            _loc2_ = var_636["null"];
            ...
            var_316 = new Map();
            var_316.add(AvatarEditorCategory.const_802,new GenericModel(this));
            var_316.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_316.add(AvatarEditorCategory.const_303,new TorsoModel(this));
            var_316.add(AvatarEditorCategory.const_1171,new LegsModel(this));
            var_316.add(AvatarEditorCategory.const_570,new WardrobeModel(this));
            var_942 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_316.getValue(AvatarEditorCategory.const_570);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_316.getValue(AvatarEditorCategory.const_570);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_943.getPalette(param1);
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_316.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_382 == null)
            {
               var_382 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_382.addChild(_view.window);
               var_382.center();
               var_382.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_802);
         if(var_178 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1138 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_594,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_943 = var_1138.getFigureData(AvatarType.HUMAN);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_944 = param3;
         var _loc4_:FigureData = var_636[param2];
         if(_loc4_ == null)
         {
            return;
         }
