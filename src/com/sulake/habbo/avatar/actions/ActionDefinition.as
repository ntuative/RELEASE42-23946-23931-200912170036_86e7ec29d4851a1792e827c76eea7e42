package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_2057 = parseInt(param1.@precedence);
         var_2059 = String(param1.@activepartset);
         var_2058 = String(param1.@assetpartdefinition);
         var_2061 = String(param1.@lay);
         var_1287 = String(param1.@geometrytype);
         var_2060 = Boolean(parseInt(param1.@main));
         var_2062 = Boolean(parseInt(param1.@var_554));
         var_2063 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1235 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_524.add(param1,new Map());
         }
         var _loc4_:Map = var_524.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_524.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1235.concat(getTypePrevents(param1));
      }
