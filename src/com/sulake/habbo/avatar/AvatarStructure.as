package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_785:AvatarActionManager;
      
      private var var_157:IAssetLibrary;
      
      private var var_2213:IAssetLibrary;
      
      private var var_1306:Boolean = false;
      
      private var var_1893:AvatarRenderManager;
      
      private var var_464:FigureData;
      ...
      private var var_1391:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_157 = param2;
         var_2213 = param3;
         var_464 = new FigureData();
         var_387 = new PartSetsData();
         _animationData = new AnimationData();
         var_1391 = new AvatarStructureDownloadSet();
      ...
      {
         return var_785.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_785.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_785.getActionDefinition(param1);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1197[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_785.getDefaultActionType();
         var _loc7_:Array = var_387.getActiveParts(param3.definition);
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_464.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_464.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_387.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_387.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.HUMAN:
               var_1391.add(new AvatarStructureDownload(var_157,_loc5_,var_464));
               break;
            case AvatarType.PET:
         }
         var_1391.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_785 = new AvatarActionManager(var_157,var_656);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_464.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_464.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_785.sortActions(param1);
      }
   }
}
