package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_117,param2,param3);
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_141,param2,param3);
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_130,param2,param3);
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_143,param2,param3);
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         attachImages();
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_679[var_1363];
         if(_loc2_ == null)
         {
            return;
         }
