package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_892:PaletteManager;
      
      private var var_599:PetDataManager;
      ...
      private function init() : void
      {
         ...
         var_599 = new PetDataManager(_loc1_,_loc3_);
         var_892 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_599.populateFigureData(_loc4_);
      ...
      {
         return var_599 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_693 = param1;
         if(var_693 == RenderMode.const_1128)
         {
            init();
         }
      }
      ...
      {
         var _loc5_:String = var_599.createAvatarFigureStringNew(param1,param2,param3);
