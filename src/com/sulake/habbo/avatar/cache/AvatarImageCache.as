package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_829:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_647)
               {
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_75.getParts(param1,(var_829 as AvatarImage).getFigure(),_loc6_,var_1287,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_75.getCanvas(var_192,var_1287);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1143[param1])
            {
            ...
            _loc10_ = var_192 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_192 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_919 || _loc32_ == AvatarAction.const_592) && (_loc6_ == AvatarBodyPartType.const_303 || _loc6_ == AvatarBodyPartType.const_1195 || _loc6_ == AvatarBodyPartType.const_1182) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_192 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
