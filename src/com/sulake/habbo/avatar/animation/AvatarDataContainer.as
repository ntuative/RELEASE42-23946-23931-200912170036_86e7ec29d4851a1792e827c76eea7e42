package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1408 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1933 = parseInt(_loc2_,16);
         var_1934 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1460 = _rgb >> 16 & 255;
         var_1459 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1495 = var_1460 / 255 * 1;
         var_1497 = var_1459 / 255 * 1;
         var_1496 = _b / 255 * 1;
         if(var_1408 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1495,var_1497,var_1496,_alphaMultiplier);
         var_984 = generatePaletteMapForGrayscale(var_1934,var_1933);
      }
