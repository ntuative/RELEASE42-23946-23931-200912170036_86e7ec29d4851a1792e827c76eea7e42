package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1577:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1407:BitmapData;
      
      private const const_1578:int = 13421772;
      ...
      private var var_572:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         var_1407 = _loc7_.content as BitmapData;
         _color = param4;
         if(param3 == null)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(var_572 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1407,var_1407.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1578;
         }
         else
         {
            _window.color = const_1577;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_790 + "_" + FigureData.const_249;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_1025 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_790 + "_" + FigureData.const_249;
