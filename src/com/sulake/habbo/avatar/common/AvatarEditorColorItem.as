package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private var var_802:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_698.width,var_698.height,true,0);
            _loc1_.bitmap.copyPixels(var_698,var_698.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1199.width,var_1199.height,true,0);
            _loc4_ = var_1199.clone();
            _loc4_.colorTransform(_loc4_.rect,var_802.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_982.width,var_982.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_982,var_982.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1407,var_1407.rect,new Point(0,0),null,null,true);
            }
         }
      }
